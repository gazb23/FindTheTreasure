    ...
    return Card(
      ...
      color: _placeColor(),
       ...
       mainAxisSize: MainAxisSize.min,
          children: <Widget>[
            Text('0'+ place.toString(), style: TextStyle(fontWeight: FontWeight.bold, color: Colors.black54),),
            SizedBox(width: 20),
            Avatar(
        ...
        trailing: Text(points.toString(), style: TextStyle(color: Colors.black87),),
      ),
    );
  }
