  ...
  Future<bool> requestLocationPermission() async {
    ...
    if (!granted){
      permissionDenied(context);
        ...
        final permission = await PlatformAlertDialog(title: 'Location Permission Required', content: 'We take your privacy seriously. We do not store your location data and only access it momentarlity to check your location to unlock challenges.', defaultActionText: 'GRANT PERMISSION').show(context);
        if (permission) {
